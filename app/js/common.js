...
$(document).ready(function () {
	...
	$(".slider_about_company").owlCarousel({
		autoPlay: 5000,
		navigation: true,
		slideSpeed: 300,
		paginationSpeed: 400,
	...
	$('.search_header form .change_value').click(function(){
	...
	ymaps.ready(function () {
		...
		var myMap = new ymaps.Map('ya-map', {
			...
			myPlacemark = new ymaps.Placemark(myMap.getCenter(), {
				...
				balloonContent: 'Какойто-поселок'
			}, {
					// Опции.
					// Необходимо указать данный тип макета.
					iconLayout: 'default#image',
					// Своё изображение иконки метки.
					iconImageHref: 'img/icons/ballon_icon.png',
					// Размеры метки.
					iconImageSize: [60, 94],
			...
			myPlacemarkWithContent = new ymaps.Placemark([55.835967, 37.753602], {
				hintContent: 'Собственный значок метки с контентом',
				balloonContent: 'что-то еще по поселкам',
				iconContent: ''
			}, {
					// Опции.
					// Необходимо указать данный тип макета.
